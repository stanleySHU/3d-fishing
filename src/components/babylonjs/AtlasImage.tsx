...
import { useAssetsManager } from '../../loaders/babylonjs/resourceManager/AssetManager';
import { TextFileResource } from '../../loaders/babylonjs/resourceManager/TextFileResource';
